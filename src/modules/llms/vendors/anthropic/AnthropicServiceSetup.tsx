...
export function AnthropicServiceSetup(props: { serviceId: DModelsServiceId }) {
  ...
  return <>
    ...
    {advanced.on && <FormTextField
      ...
      title='API Host'
      description={<>e.g., <Link level='body-sm' href='https://github.com/enricoros/ylsoo-aivory/blob/main/docs/config-aws-bedrock.md' target='_blank'>bedrock-claude</Link></>}
