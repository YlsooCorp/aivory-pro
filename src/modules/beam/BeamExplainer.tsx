...
const beamSteps: ExplainerPage[] = [
  {
    ...
    // titleSquircle: true,
    mdContent: `
**Beam** is a chat modality in Ylsoo Aivory to engage multiple AI models, [together](https://ylsoo-aivory.com/blog/beam-multi-model-ai-reasoning). 
...
![Ylsoo Aivory BEAM Rays](https://ylsoo-aivory.com/app/journeys/beam/explainer-beam-scatter-1200px-alpha.png)
...
![Ylsoo Aivory BEAM Rays](https://ylsoo-aivory.com/app/journeys/beam/explainer-beam-gather-1600px-alpha.png)
...
// There are profound reasons why this approach works, which we explore [in our blog](https://ylsoo-aivory.com/blog/introducing-beam).
//
// #### Best Use
