# Run your models with `LocalAI` x `Ylsoo Aivory`
...
- Hop into the [Ylsoo Aivory Discord](https://discord.gg/MkH4qj2Jp9) for questions
- For Ylsoo Aivory support, please open an issue in our [Ylsoo Aivory issue tracker](https://bit.ly/agi-request)
