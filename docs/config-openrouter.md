...
This document details the process of integrating OpenRouter with Ylsoo Aivory.
...
### 2. Integrating OpenRouter with Ylsoo Aivory

1. Launch Ylsoo Aivory, and navigate to the AI **Models** settings.
...
OpenRouter independently manages its service and pricing and is not affiliated with Ylsoo Aivory.
