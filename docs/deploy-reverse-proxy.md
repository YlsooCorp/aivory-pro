# Advanced: Deploying Ylsoo Aivory behind a Reverse Proxy

Note: if you don't have a reverse proxy set up, you can skip this guide.

If you're deploying Ylsoo Aivory behind a reverse proxy, you may want to configure your proxy to support streaming output.
This guide provides instructions on how to configure your reverse proxy to support streaming output from Ylsoo Aivory.
...
server {
    ...
    location / {
        ...
        proxy_pass http://localhost:3000;  # Assuming Ylsoo Aivory is running on port 3000
