...
**LiveFile** is a powerful feature in Ylsoo Aivory that allows you to **pair and synchronize
your documents and code blocks** with files on your local system.

This feature enables a **two-way connection between Ylsoo Aivory and your local files on disk**,
saving you time and effort.

With LiveFile, you can:

- **Pair** documents and code blocks with local files.
- **Monitor** changes in local files and update content in Ylsoo Aivory.
- **Refresh** chat attachments with the latest content.
- **Save** edits made in Ylsoo Aivory back to your local files.
...
- **Limitations:**
  ...
  - **Saving Overwrites:**
    - Saving changes in Ylsoo Aivory will **overwrite the entire file**.
...
LiveFile can be enabled automatically or manually in your Ylsoo Aivory workflow.
...
3. **Grant Permissions**
  - When prompted, allow Ylsoo Aivory to access the file.
...
- **Automatic Monitoring:**
  ...
  - If the file is modified outside of Ylsoo Aivory, you'll be shown the changes in the LiveFile bar.
  - There is also a **"Replace with File"** option to manually load the latest content and see the changes.

- **Refreshing Content:**
  - Click **"Replace with File"** (🔄) to load the latest content from the paired file into Ylsoo Aivory.

### Saving Edits Back to Paired Files

- **Editing Attachments or Code Blocks:**
  - Modify the content directly within Ylsoo Aivory.
...
- **Monitor External Changes:**
  - Refresh content in Ylsoo Aivory if the local file has been modified outside the application.
...
- **LiveFile Options Not Visible:**
  ...
  - Check that you have the latest version of Ylsoo Aivory.

- **Permission Issues:**
  - Confirm that you granted Ylsoo Aivory permission to access your files.
...
- **Performance:** 
  ...
  - Works with the Ylsoo Aivory attachment system to recursively add directories.
...
## Another Ylsoo Aivory First!

You can significantly boost your productivity and streamline your workflow within Ylsoo Aivory
...
Join us in enjoying and enhancing this feature on [ylsoo-aivory.com](https://ylsoo-aivory.com), or
[GitHub](https://github.com/enricoros/ylsoo-aivory) for support and [Discord](https://discord.gg/MkH4qj2Jp9)
to share the love.