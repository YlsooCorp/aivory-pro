...
Ensuring microphone access is essential for using voice features in applications like Ylsoo Aivory.

## Desktop Browsers

### Google Chrome (All Platforms, recommended)

1. Open the website (e.g., Ylsoo Aivory) in Chrome.
...
2. Click **Safari** in the top menu bar.
   ...
   - Find Ylsoo Aivory (or localhost for developers) in the list and set it to **Allow**.
   - Close the Settings window.
3. **Refresh** the page.

This quick and simple fix should get essential voice input working in Ylsoo Aivory on your Mac.
...
For persistent issues, consult your browser's official support resources or contact Ylsoo Aivory support.

## Technical Details

Ylsoo Aivory uses the [Web Speech API (SpeechRecognition)](https://developer.mozilla.org/en-US/docs/Web/API/SpeechRecognition)
